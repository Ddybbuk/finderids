  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-sm text-blue-600 mt-1">
              <li>Use the exact ID for best results</li>
      ...
      <div className="mt-6 p-4 border border-yellow-200 bg-yellow-50 rounded-md">
        <h3 className="font-medium text-yellow-700 mb-2">Example IDs to try:</h3>
        <div className="grid grid-cols-2 gap-2 text-sm">
          <div className="p-2 bg-yellow-100 rounded">D001</div>
          <div className="p-2 bg-yellow-100 rounded">D002</div>
          <div className="p-2 bg-yellow-100 rounded">D003</div>
          <div className="p-2 bg-yellow-100 rounded">D004</div>
        </div>
      </div>
